...
#define HARDFORK_1009_TIME (fc::time_point_sec( 1544860800 )) // for mainnet test, 2018-12-15T08:00:00
#endif

// set min witness num 21
#ifndef HARDFORK_1010_TIME
#define HARDFORK_1010_TIME (fc::time_point_sec( 1544860800 )) // for mainnet test, 2018-12-15T08:00:00
#endif

// contract call fee
#ifndef HARDFORK_1011_TIME
#define HARDFORK_1011_TIME (fc::time_point_sec( 1544860800 )) // for mainnet test, 2018-12-15T08:00:00
#endif

// update active trustnodes
#ifndef HARDFORK_1012_TIME
#define HARDFORK_1012_TIME (fc::time_point_sec( 1544860800 )) // for mainnet test, 2018-12-15T08:00:00
#endif

// enable witness guaranty
#ifndef HARDFORK_1129_TIME
#define HARDFORK_1129_TIME (fc::time_point_sec( 1544860800 )) // for mainnet test, 2018-12-15T08:00:00
#endif
